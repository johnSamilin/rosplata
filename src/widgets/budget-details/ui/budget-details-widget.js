...
import { TransactionsListWidget } from "../../transactions-list";
import { currencyFormatters, getBudgetBalanceFromTransactions, mapArrayToObjectId } from "../../../shared/lib/utils";
import { allowedUserStatuses, PARTICIPANT_STATUSES } from "../../../shared/config/user-statuses";
import { Alert } from "../../../shared/ui/alert";
import { ParticipantsListWidget } from "../../participants-list";
import { FeatureDetector } from "../../../shared/lib/feature-detector";
import { Router } from '../../../shared/lib/router'
import { BudgetSettingsWidget } from "./components/budget-settings-widget";
import { filterBannedUserTransactions } from "../../../shared/lib/transactions-utils";

importStyle('/src/widgets/budget-details/ui/budget-details-widget.css')

const template = document.querySelector('template#budget-details-template')
const Api = new RequestManager('budget')
const transactionsController = new TransactionsListWidget()
const participantsController = new ParticipantsListWidget()
const settingsController = new BudgetSettingsWidget()

const isMobile = FeatureDetector.isMobile

export class BudgetDetailsWidget extends AnimatedComponent {
    ...
    showInviteDialog = async () => {
        ...
        try {
            ...
            const { InviteDialog } = await import('../../../shared/ui/invite-dialog')
            InviteDialog.data = {
